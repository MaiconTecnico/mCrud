...
uses
  ...
  mCrud.view.consultaclientes in 'src\view\mCrud.view.consultaclientes.pas' {FrmConsultaClientes},
  mCrud.view.cadastroclientes in 'src\view\mCrud.view.cadastroclientes.pas' {FrmCadastro},
  ...
  mCrud.model.entity.telefone in 'src\model\entity\mCrud.model.entity.telefone.pas',
  mCrud.controller.dto.telefone in 'src\dto\mCrud.controller.dto.telefone.pas',
  mCrud.services.fastreports in 'src\services\mCrud.services.fastreports.pas' {DMFastReports: TDataModule};
